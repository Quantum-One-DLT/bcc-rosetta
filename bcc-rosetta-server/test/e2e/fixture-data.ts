...
const slotLeader2b1 = 'ColeGenesis-52df0f2c5539b2b1';
export const block1000WithoutTxs = {
  block: {
    ...
    metadata: {
      transactionsCount: 0,
      createdBy: 'ColeGenesis-8e8a7b0f4a23f07a',
      size: 669,
      epochNo: 0,
      slotNo: 999
    },
...
export const block23236WithTransactions = {
  block: {
    ...
    metadata: {
      transactionsCount: 2,
      createdBy: 'ColeGenesis-64c61078e9577d3b',
      size: 1155,
      epochNo: 1,
      slotNo: 23249
    },
...
export const blockWith8Txs = {
  block: {
    ...
    metadata: {
      transactionsCount: 8,
      createdBy: 'ColeGenesis-888c451ae09a16fe',
      size: 2845,
      epochNo: 1,
      slotNo: 23725
    }
    ...
    operations: [
      {
        ...
        amount: { value: '-5846309394', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
      ...
      },
      {
        ...
        metadata: { withdrawalAmount: { value: '-112588803', currency: { symbol: 'BCC', decimals: 6 } } }
      },
      {
        ...
        amount: { value: '5158722796', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
      ...
      },
      {
        ...
        amount: { value: '800000000', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
  ...
  transaction: {
    operations: [
      ...
      },
      {
        ...
        metadata: { depositAmount: { value: '2000000', currency: { symbol: 'BCC', decimals: 6 } } }
      },
      {
        operation_identifier: { index: 2, network_index: 0 },
    ...
    operations: [
      {
        ...
        amount: { value: '-51047025535', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
      ...
      },
      {
        ...
        amount: { value: '51046846482', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
    ...
    operations: [
      {
        ...
        amount: { value: '-7126681496', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
          coin_identifier: {
      ...
      },
      {
        ...
        metadata: { refundAmount: { value: '-2000000', currency: { symbol: 'BCC', decimals: 6 } } }
      },
      {
        operation_identifier: { index: 2, network_index: 0 },
        related_operations: [{ index: 0 }, { index: 1 }],
        ...
        amount: { value: '7128509879', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
          coin_identifier: {
    ...
    operations: [
      {
        ...
        amount: { value: '-52425749', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
      ...
      },
      {
        ...
        metadata: {
          depositAmount: { value: '500000000', currency: { symbol: 'BCC', decimals: 6 } },
      ...
      },
      {
        ...
        amount: { value: '52229492', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
    ...
    operations: [
      {
        ...
        amount: { value: '-597821255', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
      ...
      },
      {
        ...
        metadata: {
          depositAmount: { value: '500000000', currency: { decimals: 6, symbol: 'BCC' } },
          poolRegistrationParams: {
      ...
      },
      {
        ...
        amount: { value: '97610698', currency: { symbol: 'BCC', decimals: 6 } },
        coin_change: {
  ...
  operations: [
    {
      ...
      amount: { value: '-12906630', currency: { decimals: 6, symbol: 'BCC' } },
      coin_change: {
    ...
    },
    {
      ...
      amount: { value: '12722649', currency: { symbol: 'BCC', decimals: 6 } },
      coin_change: {
...
// ./bcc-cli sophie transaction build-raw --tx-in 2f23fd8cca835af21f3ac375bac601f97ead75f2e79143bdf71fe2c4be043e8f#1 \
...
export const CONSTRUCTION_PAYLOADS_REQUEST_WITH_COLE_INPUT: Components.Schemas.ConstructionPayloadsRequest = {
  network_identifier: {
    blockchain: 'bcc',
    network: 'mainnet'
  },
...
export const CONSTRUCTION_PAYLOADS_REQUEST_WITH_COLE_OUTPUT: Components.Schemas.ConstructionPayloadsRequest = {
  network_identifier: {
    blockchain: 'bcc',
    network: 'mainnet'
  },
...
export const CONSTRUCTION_PAYLOADS_REQUEST_WITH_COLE_INPUT_RESPONSE = cbor
  .encode([
    ...
    constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_WITH_COLE_INPUT)
  ])
  .toString('hex');
...
// The following transactions were generated using using the `bcc-serialization-lib` with dummy signatures
...
export const SIGNED_TX_WITH_COLE_OUTPUT =
...
export const SIGNED_TX_WITH_COLE_INPUT =
...
export const CONSTRUCTION_SIGNED_TX_INPUT_WITH_COLE_ADDRESS_AND_EXTRA_DATA = cbor
  .encode([SIGNED_TX_WITH_COLE_INPUT, constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_WITH_COLE_INPUT)])
  .toString('hex');

export const CONSTRUCTION_SIGNED_TX_WITH_COLE_ADDRESS_AND_EXTRA_DATA = cbor
  .encode([SIGNED_TX_WITH_COLE_OUTPUT, constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_WITH_COLE_OUTPUT)])
  .toString('hex');
...
export const coinsWithEmptyNameToken = [
  {
    ...
    amount: { value: '106236428', currency: { symbol: 'BCC', decimals: 6 } },
    metadata: {
      '909bde6249251257d56008f5a852200b47392676c23724f2fdda932c7bea5599:1': [
        {
          policyId: '5ee467ea4ef07b6f41d88d26ea4c872db6f47ddf27c0d7d3745462a8',
