...
# As Bcc Rosetta is mostly some queries and data mapping it makes no sense to mock repository
...
# See: bcc-rosetta-server/src/server/db/queries/blockchain-queries.ts#findBlock
