...
import { configure, SUPPORTED_ERAS } from '../../../../../src/server/utils/bcc/cli/bccnode-cli';
...
const WRONG_ERA_DECODING_ERROR =
  'TextEnvelope decode error: DecoderErrorDeserialiseFailure "Sophie Tx" (DeserialiseFailure 102 "expected word")';

const WRONG_ERA_ERROR =
  'Sophie command failed: transaction submit  Error: The era of the node and the tx do not match. The node is running in the Evie era, but the transaction is for the Jen era.';

describe('BccNode CLI', () => {
