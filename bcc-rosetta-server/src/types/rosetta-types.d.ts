declare namespace Components {
  namespace Schemas {
    ...
    export interface Operation {
       ...
       * }
       */
      metadata?: /* Metadata related to Bcc operations */ OperationMetadata;
    }
    /**
    ...
    /**
     * Metadata related to Bcc operations
     */
    ...
    export interface PoolRegistrationParams {
      ...
      /**
       * Entropic amount to pledge
       */
      pledge: string;
      /**
       * Operational costs per epoch entropic
       */
      cost: string;
      poolOwners: string[];
      relays: Relay[];
